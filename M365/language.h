...
/*
  ...
  const char noBUS2[] PROGMEM = {"connecte!"};
  const char noBUS3[] PROGMEM = {"Pas de donnees"};
  const char noBUS4[] PROGMEM = {"à afficher!"};

  const char confScr1[] PROGMEM = {"Gros Compteur: "};
  const char confScr2[] PROGMEM = {"Gros Compt.: "};
  const char confScr2a[] PROGMEM = {" VITESSE"};
  const char confScr2b[] PROGMEM = {"COURANT"};
  ...
  const char infoScr2[] PROGMEM = {"Allumee depuis :"};

  const char battScr[] PROGMEM = {">>> Freiner pour sortir <<<"};

  const char M365CfgScr1[] PROGMEM = {"Controle Regul : "};
  const char M365CfgScr2[] PROGMEM = {"MAJ Regul "};
  const char M365CfgScr3[] PROGMEM = {"on/off Feu Arr :    "};
  const char M365CfgScr4[] PROGMEM = {"Maj Feu Arriere"};
  ...
  const char l_Hibernate[] PROGMEM = {"hiberner"};
  
  const char l_Yes[] PROGMEM = {"   OUI"};
  const char l_No[] PROGMEM =  {"   NON"};
  const char l_On[] PROGMEM =  {"Allume"};
  ...
  */
  ...
  const char l_Hibernate[] PROGMEM = {"HIBERN"};
